...
def Create_World(): 
    ...
    pyrosim.Send_Cube(name="Box", pos=[1,2,z] , size=[length,width,height])
...
def Create_Robot(): 
    ...
    pyrosim.Send_Joint( name = "Link0_Link1" , parent= "Link0" , child = "Link1" , type = "revolute", position = [.5,0,1.0])
